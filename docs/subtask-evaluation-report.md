...
_Generated by `python -m eval.subtask_eval --write-report` on 2026-09-15._
...
_Generated by `python -m eval.subtask_eval --write-report` on 2026-09-15. Re-run to refresh._
