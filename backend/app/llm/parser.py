...
# Which model family runs the extraction. Gemini is the default: on both the short and long test
# sets it is never significantly behind Claude Sonnet on F1, it is more precise on both, and it
# costs a fraction of the price - see docs/evaluation-report.md. Set LLM_PROVIDER=anthropic to fall back to Claude; both backends
