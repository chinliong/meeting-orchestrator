...
Gemini is the implemented parser: on both the short and long annotated test sets it is never
significantly behind Claude Sonnet on F1 and is more precise, at a fraction of the price
